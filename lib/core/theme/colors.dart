...
class LightAppColors extends AppColors {
  ...
  @override
  Color get primary => const Color(0xFFFFAA05);

  @override
  Color get secondary => const Color(0xFF000000);

  @override
  Color get tertiary => const Color(0xFFFFF5E1);
  ...
  @override
  Color get neutral => const Color(0xFFFEFEFE);

  @override
  Color get neutral_0 => const Color(0xFFF6F6F6);
...
extension TextStyleColor on TextStyle {
  ...
  TextStyle primaryContainer(BuildContext context) => withColor(context.primaryContainer);

  TextStyle onPrimaryContainer(BuildContext context) => withColor(context.onPrimaryContainer);
  ...
  TextStyle secondaryContainer(BuildContext context) => withColor(context.secondaryContainer);

  TextStyle onSecondaryContainer(BuildContext context) => withColor(context.onSecondaryContainer);
  ...
  TextStyle tertiaryContainer(BuildContext context) => withColor(context.tertiaryContainer);

  TextStyle onTertiaryContainer(BuildContext context) => withColor(context.onTertiaryContainer);
